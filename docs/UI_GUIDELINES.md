...
**Font Family:** Use a modern, clean sans-serif (e.g., _Inter_, _Outfit_, or _SF Pro/Roboto_ via system fonts).
...
- **Library:** _Lucide Icons_ (or Phosphor Icons) for consistent, modern stroke-based iconography.
...
- **States:**
  - _Default:_ Border color.
  - _Focus:_ Primary border color + subtle ring (Admin).
  - _Error:_ Danger border + Danger caption text below.
  - _Disabled:_ Muted background, non-interactive.
