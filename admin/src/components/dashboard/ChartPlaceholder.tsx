...
export const ChartPlaceholder = ({
  ...
  return (
    <Card
      className={`border-none shadow-card flex flex-col ${className || ""}`}
    >
      <CardHeader>
      ...
      <CardContent className="flex-1 flex flex-col items-center justify-center p-8 min-h-[300px]">
        ...
        <p className="text-textSecondary-light dark:text-textSecondary-dark text-center">
          Chart data visualization will be available once the backend provides
          the necessary time-series endpoints.
        </p>
      </CardContent>
    </Card>
  );
