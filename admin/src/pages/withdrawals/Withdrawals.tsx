...
const EmptyState = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <h3 className="text-lg font-semibold text-textMain-light dark:text-textMain-dark">
        {title}
      </h3>

      <p className="mt-2 max-w-md text-sm text-textSecondary-light dark:text-textSecondary-dark">
        {description}
      </p>
            ...
            >
              {requests.map((req: any) => (
                <TableRow key={req._id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={getWithdrawalBadgeVariant(
                        req.status
                      )}
                    >
                      {req.status}
      ...
      >
        <div className="space-y-4 pt-2">
          <p className="text-sm text-textSecondary-light dark:text-textSecondary-dark">
            ...
            <strong>{actionType}</strong> on withdrawal request
            of{' '}
            ...
            for{' '}
            <strong>
              {selectedReq?.userId?.name || 'Creator'}
            </strong>
            .
          </p>
            ...
            {actionType === 'REJECT' && (
              <p className="text-rose-500 font-semibold pt-1">
                * Rejecting this request will automatically refund
                ₹{selectedReq?.amount} back to the creator's
