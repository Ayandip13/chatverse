  ...
  const resolveReportMutation = useMutation({
    mutationFn: async (payload: {
      ...
      const response = await apiClient.patch(
        `/admin/reports/${payload.reportId}`,
        {
              ...
              {reports.map((report: any) => (
                <TableRow key={report._id}>
                  ...
                  <TableCell className="max-w-[200px]">
                    <div className="text-sm font-semibold text-textMain-light dark:text-textMain-dark">
                      {report.reason}
                    </div>
                    {report.notes && (
        ...
        {selectedReport && (
          <div className="space-y-4 pt-2 text-sm">
            <div className="grid grid-cols-2 gap-4 p-3 bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark">
              <div>
                <span className="text-xs text-textSecondary-light dark:text-textSecondary-dark block">
                  Reporter
                </span>
            ...
            <div>
              <span className="font-semibold text-textMain-light dark:text-textMain-dark block mb-1">
                Reason:
              </span>
