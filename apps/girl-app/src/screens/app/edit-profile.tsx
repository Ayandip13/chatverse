...
export default function EditProfileScreen() {
  ...
  const [languagePreference, setLanguagePreference] = useState(
    user?.languagePreference || "English, Hindi",
  );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Profile Updated",
        "Your creator profile details have been saved!",
    ...
    >
      ...
      >
        ...
        <View className="items-center mb-6">
          ...
          <TouchableOpacity
            onPress={pickImage}
            className="mt-2.5 flex-row items-center gap-1.5 bg-pink-50 dark:bg-pink-900/30 px-3.5 py-1.5 rounded-full border border-pink-200 dark:border-pink-800"
          >
